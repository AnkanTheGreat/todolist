...
if(mainTask.length>0){
  ...
  return (
    <>
     <h1 className='bg-black text-white p-5 text-5xl font-bold text-center'>Ankan's Todo List</h1> 
      <form onSubmit={submitHandler}>
        ...
        <button className='bg-black text-white px-4 py-3 text-xxl font-bold rounded m-5'>Add Task</button>
      </form>
      <hr />
